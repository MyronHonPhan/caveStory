...
Player::Player(Graphics& graphics, float x, float y)
	: AnimatedSprite(graphics, "/Users/myronphan/caveStory/res/sprites/MyChar.png",0,0,16, 16, x, y, 100) {

	graphics.loadImage("/Users/myronphan/caveStory/res/sprites/MyChar.png");
